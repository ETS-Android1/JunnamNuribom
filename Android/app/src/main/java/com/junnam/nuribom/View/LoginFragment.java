...
public class LoginFragment extends DialogFragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ((Button)rootView.findViewById(R.id.button_login)).setOnClickListener(this);
    ...
    public class LoginAsyncTask extends AsyncTask<Void, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equals("true")) {
                Toast.makeText(getActivity(), "로그인이 성공하였습니다.", Toast.LENGTH_SHORT).show();
                if (mListener != null) {
                ...
                Toast.makeText(getActivity(), "로그인이 실패하였습니다.", Toast.LENGTH_SHORT).show();
            }
    ...
    private String JsonLogin() {
        ...
        try {
            ...
            json = jsonParse.getJSONFromUrl(URLDefine.SELECT_MEMBER_URL +"member_id=" +member_id +"&member_pass=" +member_pass);
            ...
            if (json != null) {
                ...
                for (int i = 0; i < contacts.length(); i++) {
                    ...
                    memberData.setMember_id(c.getString("member_id"));
